...
| `/宿敌ls` | 生成宿敌选手列表图片，地区优先且最多展示 50 人 | `/宿敌ls`、`/宿敌ls @某人`、`/宿敌ls 2026ZHANG01` |
...
- 适配 WCA 新增项目 FTO，补充 WCA 项目名称、排序和图片展示映射
- `/pr`、`/prpk`、`/pktwo` 跨平台成绩合并支持识别 WCA `fto` 与 one 平台 `FTO`
...
- 新增 `/宿敌ls` 指令，用图片列出具体宿敌选手，按地区、洲内其他、世界其他优先展示，最多展示 50 人
